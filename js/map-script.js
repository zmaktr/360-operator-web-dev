    ...
    map.data.loadGeoJson(geoJsonFile, null, function(features){
        markers = features.map(function(feature){
            var marker = new google.maps.Marker({
                ...
                icon: {
                    url: `./assets/map-images/icon_${feature.getProperty('category')}.png`,
                }
            });
            ...
            marker.addListener('click', function(event){
                ...
                const content = `
                    <img style="float:left; align-items:center; width:120px; margin-top:0px" src="./assets/map-images/info_icon_${category}.png">
